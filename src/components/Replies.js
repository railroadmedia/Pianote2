                        ...
                        >
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <View style={{flexDirection: 'row'}}>
                                    ...
                                    >
                                        <AntIcon
                                            name={(this.state.replies[index][8] == 1) ? 'like1' : 'like2'}
                                            size={20*factorRatio}
        ...
        return (
            <View key={'componentContainer'}
                style={[
                    ...
                    position: 'absolute',
                    bottom: 0,
                    height: fullHeight - (((isNotch) ? fullHeight*0.05 : fullHeight*0.03) + 
                        ((onTablet) ? fullHeight*0.375 : fullHeight*0.275)),
                    width: fullWidth,
                    zIndex: 10,
                }]}
            >
                    ...
                    <View style={{flex: 1}}>
                        ...
                        >
                            ...
                            >
                                <View>
                                    <View style={{alignItems: 'center'}}>
                                        ...
                                        >
                                            {this.changeXP(this.state.parentComment[4])}
                                        </Text>
                                    </View>
                                    <View style={{flex: 1}}/>
                                </View>
                                ...
                                >
                                    ...
                                    >
                                        {this.state.parentComment[1]} | {this.state.parentComment[2]} | {this.state.parentComment[3]}
                                    </Text>
                                    <View style={{height: 50*factorVertical}}>
                                        ...
                                        <View style={{flexDirection: 'row'}}>
                                            <View style={{flexDirection: 'row'}}>
                                                ...
                                                >
                                                    <AntIcon
                                                        name={(this.state.parentComment[8] == 1) ? 'like1' : 'like2'}
                                                        size={20*factorRatio}
                                                        color={colors.pianoteRed}
                                                    />
                                                </TouchableOpacity>
                                                <View style={{width: 10*factorHorizontal}}/>
                                                {this.state.parentComment[5] && (
                                                <View>
                                                    <View style={{flex: 1}}/>
                                                    <View 
                                                        style={[
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {this.state.parentComment[6]} LIKES
                                                        </Text>
                                                    </View>
                                                    <View style={{flex: 1}}/>
                                                </View>
                                            ...
                                            <View style={{flexDirection: 'row'}}>
                                                ...
                                                <View>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {this.state.parentComment[5]} {(this.state.parentComment[5] == 1) ? 'REPLY' : 'REPLIES'}
                                                        </Text>
                                                    </View>
                                                    <View style={{flex: 1}}/>
                                                </View>
                            ...
                            >
                                ...
                                <TouchableOpacity key={'makeReply'}
                                    onPress={() => {
                                        this.setState({
