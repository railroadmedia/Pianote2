                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'HOME' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'HOME') ? 
                                    '900' : '700',
                            }}
                        >
                            HOME
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'LESSONS' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'LESSONS') ? 
                                    '900' : '700',
                            }}
                        >
                            LESSONS
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'PACKS' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'PACKS') ? 
                                    '900' : '700',
                            }}
                        >
                            PACKS
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'MY LIST' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'MY LIST') ? 
                                    '900' : '700',
                            }}
                        >
                            MY LIST
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'ALL TYPES' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'ALL TYPES') ? 
                                    '900' : '700',
                            }}
                        >
                            ALL TYPES
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'ALL PACKS' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'ALL PACKS') ? 
                                    '900' : '700',
                            }}
                        >
                            ALL PACKS
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == '500 SONGS' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == '500 SONGS') ? 
                                    '900' : '700',
                            }}
                        >
                            500 SONGS IN 5 DAYS
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'SIGHT READING' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'SIGHT READING') ? 
                                    '900' : '700',
                            }}
                        >
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'FASTER FINGERS' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'FASTER FINGERS') ? 
                                    '900' : '700',
                            }}
                        >
                            FASTER FINGERS
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'ALL LESSONS' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'ALL LESSONS') ? 
                                    '900' : '700',
                            }}
                        >
                            ALL LESSONS
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'ADDED TO LIST' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'ADDED TO LIST') ? 
                                    '900' : '700',
                            }}
                        >
                            ADDED TO LIST
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'IN PROGRESS' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'IN PROGRESS') ? 
                                    '900' : '700',
                            }}
                        >
                            IN PROGRESS
                        ...
                        <Text
                            style={{
                                ...
                                fontSize: (this.props.parentPage == 'COMPLETE' ? 25 : 21) + 
                                        (onTablet ? 27.5 : 0),
                                fontWeight: (Platform.OS == 'android') ? 'bold' : (this.props.parentPage == 'COMPLETE') ? 
                                    '900' : '700',
                            }}
                        >
                            COMPLETE
