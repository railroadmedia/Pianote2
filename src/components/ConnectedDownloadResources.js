...
const renderSvgs = extension => {
  switch (extension) {
    case 'zip':
      return (
        <FontIcon name={'file-zip-o'} size={20 * factorRatio} color={'white'} />
      );
    case 'mp3':
      return (
        <FontIcon name={'music'} size={20 * factorRatio} color={'white'} />
      );

    case 'pdf':
      return (
        <FontIcon name={'file-pdf-o'} size={20 * factorRatio} color={'white'} />
      );
  }
};
