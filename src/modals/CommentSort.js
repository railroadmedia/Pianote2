        ...
        >
          ...
          >
            <TouchableOpacity
              key={'Popular'}
              onPress={() => {
                this.props.hideCommentSort(), this.props.changeSort('Popular');
              }}
              style={{
                flex: 0.4,
            ...
            <TouchableOpacity
              key={'Mine'}
              onPress={() => {
                this.props.hideCommentSort(), this.props.changeSort('Mine');
              }}
              style={{
                flex: 0.4,
                paddingLeft: fullWidth * 0.05,
            ...
            <TouchableOpacity
              key={'newest'}
              onPress={() => {
                this.props.hideCommentSort(), this.props.changeSort('Newest');
              }}
              style={{
                flex: 0.4,
                paddingLeft: fullWidth * 0.05,
            ...
            <TouchableOpacity
              key={'oldest'}
              onPress={() => {
                this.props.hideCommentSort(), this.props.changeSort('Oldest');
              }}
              style={{
                flex: 0.4,
                paddingLeft: fullWidth * 0.05,
