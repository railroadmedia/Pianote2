        ...
        return (
            <View style={styles.container}>          
                ...
                >
                    ...
                    >
                        <TouchableOpacity key={'relevance'}
                            onPress={() => {
                        ...
                        >
                            <View>
                                ...
                                <EntypoIcon
                                    name={'check'}
                                    size={20*factorRatio}
                                    color={(this.state.currentSort == 'Relevance') ? 'white' : colors.mainBackground}
                                />
                                <View style={{flex: 1}}/>
                            </View>
                            ...
                            <View>
                                ...
                                <Text
                                    style={{
                                        ...
                                        color: (this.state.currentSort == 'Relevance') ? 'white' : colors.secondBackground,
                                    }}
                                >
                                    Relevance
                                </Text>
                        ...
                        >
                            <View>
                                ...
                                <EntypoIcon
                                    name={'check'}
                                    size={20*factorRatio}
                                    color={(this.state.currentSort == 'Trending') ? 'white' : colors.mainBackground}
                                />
                                <View style={{flex: 1}}/>
                            </View>
                            <View style={{width: 15*factorHorizontal}}/>
                            <View>
                                ...
                                <Text
                                    style={{
                                        fontSize: 16*factorRatio,
                                        fontFamily: 'OpenSans-Regular',
                                        color: (this.state.currentSort == 'Trending') ? 'white' : colors.secondBackground,
                                    }}
                                >
                                    Trending
                                </Text>
                        ...
                        >
                            <View>
                                ...
                                <EntypoIcon
                                    name={'check'}
                                    size={20*factorRatio}
                                    color={(this.state.currentSort == 'Popular') ? 'white' : colors.mainBackground}
                                />
                                <View style={{flex: 1}}/>
                            </View>
                            <View style={{width: 15*factorHorizontal}}/>
                            <View>
                                ...
                                <Text
                                    style={{
                                        fontSize: 16*factorRatio,
                                        fontFamily: 'OpenSans-Regular',
                                        color: (this.state.currentSort == 'Popular') ? 'white' : colors.secondBackground,
                                    }}
                                >
                                    Most Popular
                                </Text>
