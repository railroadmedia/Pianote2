    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ScrollView style={localStyles.scrollContainer}>
          ...
          <Text style={[localStyles.text, localStyles.subtitle]}>Cookies</Text>
          <Text style={localStyles.text}>
          ...
          <Text style={[localStyles.text, localStyles.subtitle]}>User</Text>
          <Text style={localStyles.text}>
          ...
          <Text style={[localStyles.text, localStyles.subtitle]}>Facebook</Text>
          <Text style={localStyles.text}>
