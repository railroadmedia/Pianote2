      ...
      <View style={styles.stepsContainer}>
        <View
          ...
          style={{
            ...
            borderBottomRightRadius: this.props.step == 1 ? 40 * factor : 0,
        ...
        >
          <Text
            style={[styles.text, { fontSize: (onTablet ? 10 : 10) * factor }]}
          >
            Step 1:
          </Text>
          <Text
        ...
        <View
          style={[
            styles.centerContent,
            {
              ...
              borderBottomRightRadius: this.props.step == 2 ? 40 * factor : 0,
        ...
        <View
          style={[
            styles.centerContent,
            {
              ...
              borderBottomRightRadius: this.props.step == 3 ? 40 * factor : 0,
