                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Tap the download button on any lesson and the
                                lesson materials needed to complete that lesson
                                will be stored on your device in the "Downloads"
                                section.
                            </Text>
                            <View style={{height: 25 * factorVertical}} />
                            <Text
                        ...
                        >
                            <View key={'dots'} style={{flexDirection: 'row'}}>
                                <View style={{flex: 1}} />
                                <View style={{justifyContent: 'center'}}>
                                    <View
                                        style={{
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Your lesson progress is synced between the
                                Pianote App and the Pianote Website.
                            </Text>
                            <View style={{height: 25 * factorVertical}} />
                            <Text
                                style={{
                            ...
                            >
                                Feel free to watch a lesson on your phone, then
                                pick up where you left later in the day when
                                you're at the Piano next to your computer.
                            </Text>
                            <View style={{flex: 1}} />
                            <View
                                key={'dots'}
