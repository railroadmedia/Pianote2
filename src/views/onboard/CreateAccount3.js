                        ...
                        >   
                            ...
                            >
                                <TouchableOpacity
                                    ...
                                    style={{paddingLeft: 12.5*factorHorizontal, flex: 1}}
                                >
                                    <EntypoIcon
                                        name={'chevron-thin-left'}
                                        size={22.5*factorRatio}
                                ...
                                >
                                    ...
                                    >
                                        <TouchableOpacity
                                            ...
                                            onPress={() => {
                                                this.myScroll.scrollTo({x: fullWidth*2, y: 0, animated: true}),
                                ...
                                <View style={{flex: 0.35}}>
                                    ...
                                    >
                                        ...
                                        <View
                                            style={[
                                                styles.centerContent, {
                                                width: (onTablet) ? fullWidth*0.1*factorRatio : fullWidth*0.2*factorRatio,
                                                height: (onTablet) ? fullWidth*0.1*factorRatio : fullWidth*0.2*factorRatio,
                                                borderRadius: 100*factorRatio,
                                                backgroundColor: '#fb1b2f',
                                            }]}
                                        >
                                            <LearningPaths
                                                height={(onTablet) ? fullWidth*0.06*factorRatio : fullWidth*0.125*factorRatio}
                                                width={(onTablet) ? fullWidth*0.06*factorRatio : fullWidth*0.125*factorRatio}
                                                fill={'white'}
                                            />
                                        </View>
                                        <View style={{flex: 1}}/>
                            ...
                            >
                                <View style={{flex: 0.35}}>
                                    ...
                                    >
                                        ...
                                        >
                                            <Support
                                                height={(onTablet) ? fullWidth*0.065*factorRatio : fullWidth*0.135*factorRatio}
                                                width={(onTablet) ? fullWidth*0.065*factorRatio : fullWidth*0.135*factorRatio}
                                                fill={'white'}
                                            />
                                        </View>
                                        <View style={{flex: 1}}/>
                        ...
                        >
                            ...
                            >
                                ...
                                <View style={{flexDirection: 'row'}}>
                                    <FastImage
                                        style={{
                                            height: (onTablet) ? fullHeight*0.275 : fullHeight*0.225,
