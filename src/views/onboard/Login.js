        ...
        >
          ...
          >
            ...
            >
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <View
                      style={{
                        ...
                        borderWidth: 2,
                        borderColor: this.state.page == 1 ? '#fb1b2f' : 'grey'
                      }}
                    ></View>
                    <View
                      style={{
                    ...
                    <View
                      style={{
                        ...
                        borderWidth: 2,
                        borderColor: this.state.page == 2 ? '#fb1b2f' : 'grey'
                      }}
                    ></View>
                    <View
                      style={{
                    ...
                    <View
                      style={{
                        ...
                        borderWidth: 2,
                        borderColor: this.state.page == 3 ? '#fb1b2f' : 'grey'
                      }}
                    ></View>
                    <View
                      style={{
                    ...
                    <View
                      style={{
                        ...
                        borderWidth: 2,
                        borderColor: this.state.page == 4 ? '#fb1b2f' : 'grey'
                      }}
                    ></View>
                    <View
                      style={{
                    ...
                    <View
                      style={{
                        ...
                        borderRadius: 100,
                        backgroundColor:
                          this.state.page == 5 ? '#fb1b2f' : 'transparent',
                        borderWidth: 2,
                        borderColor: this.state.page == 5 ? '#fb1b2f' : 'grey'
                      }}
                    ></View>
                  </View>
                </View>
              ...
              <View key={'buff'} style={{ height: fullHeight * 0.02 }}></View>
              {this.renderButtons()}
            </View>
          </View>
          <View
          ...
          >
            ...
            >
              ...
              >
                Unlike "video game" learning where you only learn what keys to
                hit, you'll actually play music with step-by-step lessons that
                will build your piano playing foundations!
              </Text>
            </View>
            <View
              key={'content1b'}
          ...
          >
            ...
            >
              ...
              >
                Nothing is better than playing to real music! So you'll get
                custom play-alongs to help you apply specific-skills PLUS
                breakdowns of popular music so you can play your favorite tunes!
              </Text>
            </View>
            <View
              key={'content1b'}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Try it for free for 7-days when you click the sign up button
                  below to set up your Pianote account.
                </Text>
              </View>
            </View>
            <View
