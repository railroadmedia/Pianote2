...
class Lessons extends React.Component {
    ...
    componentDidMount = () => {
        let deepFilters = decodeURIComponent(
    ...
    async getLiveContent() {
        ...
        let timeLive =
            new Date(content[0].live_event_start_time + ' UTC').getTime() /
            1000;
    ...
    initialValidData = (content, fromCache) => {
        try {
            ...
            return {
                ...
                outVideos:
                    allVideos.length == 0 || content.all.data.length < 20
                        ? true
                        : false,
                filtering: false,
                isPaging: false,
                    ...
                    <ScrollView
                        ...
                        refreshControl={
                            <RefreshControl
                                ...
                                refreshing={
                                    isiOS ? false : this.state.refreshControl
                                }
                            />
                        }
                                ...
                                >
                                    ...
                                    >
                                        <MoreInfoIcon
                                            pressed={() => {
                                                navigate('METHOD', {
                                                    methodIsStarted: this.state
                                                        .methodIsStarted,
                                                    methodIsCompleted: this
                                                        .state
                                                        .methodIsCompleted,
                                                });
                                            }}
