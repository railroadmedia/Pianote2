        ...
        this.panResponder = PanResponder.create({
            ...
            onPanResponderMove: (evt, gesture) => {
                ...
                if (touches.length === 2) {
                    ...
                    if (
                        Math.abs(touches[1].locationX - touches[0].locationX) -
                            this.xDiff >
                            10 ||
                        Math.abs(touches[1].locationY - touches[0].locationY) -
                            this.yDiff >
                            10
                    ) {
                    ...
                    if (t1 & t2) {
                        if (t2 - t1 < 500) {
                            ...
                            if (this.props.onDoubleTap)
                                this.props.onDoubleTap(this.fs);
                        }
                        delete this.t1;
                        delete this.t2;
                    }
            ...
            >
                ...
                >
                    {this.props.data.map((sheet, i) => {
                        let sourceUri = dldService.manageOfflinePath(
                            sheet.value,
                        );
