            ...
            >
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                {this.userId === comment.user_id && (
                  <TouchableOpacity
                    onPress={() => this.deleteComment(comment.id)}
                  >
                    <AntIcon
                      name={'delete'}
                      size={20 * factorRatio}
  ...
  async onComplete(id) {
    ...
    if (id !== this.state.id) {
      ...
      this.setState(state => ({
        ...
        showLessonComplete:
          !incompleteAssignments && nextLesson && nextLesson.id ? true : false,
                    ...
                    {this.state.relatedLessons.length > 0 && (
                      ...
                      >
                        <VerticalVideoList
                          ...
                          navigator={row => this.switchLesson(row.id)}
                        />
                      </View>
                    )}
                    <View
                              ...
                              {this.state.isReply && (
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      Lorem ipsum dolor sit smart cosaf adiffdsf
                                      eli, prascent quie eros magnia. Etrian
                                      tincidunt
                                    </Text>
                                    <View
                                      style={{
                  ...
                  >
                    ...
                    >
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.switchLesson(this.state.previousLesson.id)
                        }
                        style={[
                          styles.centerContent,
                          {
        ...
        >
          <CommentSort
            ...
            changeSort={commentSort => {
              this.setState({ commentSort }, () => this.fetchComments());
            }}
          />
        </Modal>
