    ...
    return (
      <View styles={styles.container}>
        <View
          ...
          <View
            style={{height: isNotch ? fullHeight * 0.05 : fullHeight * 0.03}}
          />
          <View
            key={'video'}
            style={{
                          ...
                          <View
                            ...
                            <View
                              ...
                              <Text
                                ...
                                Lorem ipsum dolor sit smart cosaf adiffdsf eli,
                                prascent quie eros magnia. Etrian tincidunt
                              </Text>
                              <View style={{height: 7.5 * factorVertical}} />
                              <Text
                                style={{
                              ...
                              <View style={{height: 50 * factorVertical}}>
                                ...
                                <View style={{flexDirection: 'row'}}>
                                  ...
                                  <View
                                    style={{width: 20 * factorHorizontal}}
                                  />
                                  <View style={{flexDirection: 'row'}}>
                                    <TouchableOpacity onPress={() => {}}>
                                      <MaterialIcon
