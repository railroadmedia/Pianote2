        ...
        >
          ...
          <ScrollView key={'contentContainer'} style={{ flex: 1 }}>
            <View
              ...
              style={{
                height:
                  Platform.OS == 'ios' ? fullHeight * 0.05 : fullHeight * 0.1,
                backgroundColor: colors.mainBackground
              }}
            />
                ...
                {this.state.packs.length > 0 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[0].thumbnail
                      }}
                ...
                {this.state.packs.length > 1 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[1].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
                ...
                {this.state.packs.length > 2 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[2].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
                ...
                {this.state.packs.length > 3 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[3].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
                ...
                {this.state.packs.length > 4 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[4].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
                ...
                {this.state.packs.length > 5 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[5].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
                ...
                {this.state.packs.length > 6 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[6].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
                ...
                {this.state.packs.length > 7 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[7].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
                ...
                {this.state.packs.length > 8 && (
                  ...
                  >
                    ...
                    <FastImage
                      ...
                      source={{
                        uri: this.state.packs[8].thumbnail
                      }}
                      resizeMode={FastImage.resizeMode.cover}
                    />
                  </TouchableOpacity>
