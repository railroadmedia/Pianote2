    ...
    if (this.props.navigation.state.params.filters !== null) {
      ...
      if (filters.topics.length > 0) {
        if (this.state.type == 'LESSONS') {
          if ((await filters.topics.indexOf(filterDict['LESSONS'][0])) !== -1) {
            filter1 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][1])) !== -1) {
            filter2 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][2])) !== -1) {
            filter3 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][3])) !== -1) {
            filter4 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][4])) !== -1) {
            filter5 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][5])) !== -1) {
            filter6 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][6])) !== -1) {
            filter7 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][7])) !== -1) {
            filter8 = true;
          }
          if ((await filters.topics.indexOf(filterDict['LESSONS'][8])) !== -1) {
            filter9 = true;
          }
        }
        ...
        if (this.state.type == 'SONGS') {
          if ((await filters.topics.indexOf(filterDict['SONGS'][0])) !== -1) {
            filter1 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][1])) !== -1) {
            filter2 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][2])) !== -1) {
            filter3 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][3])) !== -1) {
            filter4 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][4])) !== -1) {
            filter5 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][5])) !== -1) {
            filter6 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][6])) !== -1) {
            filter7 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][7])) !== -1) {
            filter8 = true;
          }
          if ((await filters.topics.indexOf(filterDict['SONGS'][8])) !== -1) {
            filter9 = true;
          }
        }
        if (this.state.type == 'COURSES') {
          if ((await filters.topics.indexOf(filterDict['COURSES'][0])) !== -1) {
            filter1 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][1])) !== -1) {
            filter2 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][2])) !== -1) {
            filter3 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][3])) !== -1) {
            filter4 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][4])) !== -1) {
            filter5 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][5])) !== -1) {
            filter6 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][6])) !== -1) {
            filter7 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][7])) !== -1) {
            filter8 = true;
          }
          if ((await filters.topics.indexOf(filterDict['COURSES'][8])) !== -1) {
            filter9 = true;
          }
        }
      }
            ...
            >
              ...
              >
                <MultiSlider
                  ...
                  step={1}
                  snapped={true}
                  values={[this.state.allLevels ? 10 : this.state.level]}
              ...
              >
                Occasion endeavor of soon rank be most head time tore. Colonel
                or passage to ability.
              </Text>
              <View style={{ height: 10 * factorRatio }} />
              <View
                key={'allLevels'}
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter1
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter1
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter2
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter2
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter3
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter3
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter4
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter4
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter5
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter5
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter6
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter6
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter7
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter7
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter8
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter8
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
                      ...
                      <TouchableOpacity
                        ...
                        style={[
                          styles.centerContent,
                          {
                            ...
                            marginLeft: fullWidth * 0.01,
                            borderWidth: 0.5 * factorRatio,
                            borderColor: this.state.filter9
                              ? 'transparent'
                              : colors.secondBackground,
                            backgroundColor: this.state.filter9
                              ? 'red'
                              : 'transparent',
                            borderRadius: 200
                          }
              ...
              {this.state.openInstructors && (
                ...
                >
                  ...
                  >
                    <View key={'circle7'} style={{ width: 70 * factorRatio }}>
                      <TouchableOpacity
                        onPress={() =>
                          this.setState({
                    ...
                    <View key={'circle1'} style={{ width: 70 * factorRatio }}>
                      <TouchableOpacity
                        onPress={() =>
                          this.setState({
                    ...
                    <View key={'circle3'} style={{ width: 70 * factorRatio }}>
                      <TouchableOpacity
                        onPress={() =>
                          this.setState({
                  ...
                  >
                    <View key={'circle4'} style={{ width: 70 * factorRatio }}>
                      <TouchableOpacity
                        onPress={() =>
                          this.setState({
                    ...
                    <View key={'circle5'} style={{ width: 70 * factorRatio }}>
                      <TouchableOpacity
                        onPress={() =>
                          this.setState({
