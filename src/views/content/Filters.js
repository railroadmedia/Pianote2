        ...
        if(this.props.navigation.state.params.filters !== null) {
            ...
            if(filters.topics.length > 0) {
                ...
                if(this.state.type == 'STUDENTFOCUSSHOW') {
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][0]) !== -1) {
                        filter1 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][1]) !== -1) {
                        filter2 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][2]) !== -1) {
                        filter3 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][3]) !== -1) {
                        filter4 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][4]) !== -1) {
                        filter5 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][5]) !== -1) {
                        filter6 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][6]) !== -1) {
                        filter7 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][7]) !== -1) {
                        filter8 = true
                    }
                    if(await filters.topics.indexOf(filterDict['STUDENTFOCUSSHOW'][8]) !== -1) {
                        filter9 = true
                    }                                                                             
                }
                    ...
                    >
                        ...
                        >
                            ...
                            <View style={styles.centerContent}>
                                <TouchableOpacity
                                    onPress={() => {
                                        this.props.navigation.state.params.onGoBack(this.returnFilters()),
